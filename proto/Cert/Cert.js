...
export const Cert = $root.Cert = (() => {
    ...
    Cert.CertChain = (function() {
        ...
        CertChain.NoiseCertificate = (function() {
            ...
            NoiseCertificate.decode = function (r, l, z, q, g) {
                ...
                m = g || new $root.Cert.CertChain.NoiseCertificate();
                while (r.pos < c) {
                    var s = r.pos;
                    var t = r.tag();
                    if (t === z) {
            ...
            NoiseCertificate.Details = (function() {
                ...
                Details.decode = function (r, l, z, q, g) {
                    ...
                    m = g || new $root.Cert.CertChain.NoiseCertificate.Details();
                    while (r.pos < c) {
                        var s = r.pos;
                        var t = r.tag();
                        if (t === z) {
    ...
    Cert.NoiseCertificate = (function() {
        ...
        NoiseCertificate.decode = function (r, l, z, q, g) {
            ...
            m = g || new $root.Cert.NoiseCertificate();
            while (r.pos < c) {
                var s = r.pos;
                var t = r.tag();
                if (t === z) {
        ...
        NoiseCertificate.Details = (function() {
            ...
            Details.decode = function (r, l, z, q, g) {
                ...
                m = g || new $root.Cert.NoiseCertificate.Details();
                while (r.pos < c) {
                    var s = r.pos;
                    var t = r.tag();
                    if (t === z) {

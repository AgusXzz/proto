...
const $Object = $util.global.Object, $undefined = $util.global.undefined, $Error = $util.global.Error, $RangeError = $util.global.RangeError, $TypeError = $util.global.TypeError, $parseInt = $util.global.parseInt, $String = $util.global.String, $Number = $util.global.Number, $BigInt = $util.global.BigInt;
...
export const Ephemeral = $root.Ephemeral = (() => {
    ...
    Ephemeral.EphemeralSetting = (function() {
        ...
        EphemeralSetting.decode = function (r, l, z, q, g) {
            ...
            m = g || new $root.Ephemeral.EphemeralSetting();
            while (r.pos < c) {
                var s = r.pos;
                var t = r.tag();
                if (t === z) {
